...
class AdminAchievementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->auditLogService->resourceEvent('achievement_created', 'achievement_definition', $id, $request, [
    ...
    public function update(Request $request, int $achievement)
    {
        ...
        $this->auditLogService->resourceEvent('achievement_updated', 'achievement_definition', $achievement, $request, ['action' => 'update_achievement', 'metadata' => ['name' => $data['name']]]);
    ...
    public function destroy(Request $request, int $achievement)
    {
        ...
        $this->auditLogService->resourceEvent('achievement_deleted', 'achievement_definition', $achievement, $request, ['action' => 'delete_achievement']);
    ...
    public function award(Request $request, int $achievement)
    {
        ...
        $this->auditLogService->resourceEvent('achievement_awarded', 'achievement_definition', $achievement, $request, [
