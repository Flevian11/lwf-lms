...
export default function Register({
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-[#f5f7fa] px-4 py-8 text-[#172033] transition-colors dark:bg-[#0b1220] dark:text-[#f3f6fc] sm:py-12">
                    ...
                    <section className="w-full rounded-[8px] border border-[#d8dee9] bg-white p-6 shadow-[0_2px_8px_rgba(23,32,51,0.08)] dark:border-[#2a3850] dark:bg-[#111827] dark:shadow-[0_2px_10px_rgba(0,0,0,0.28)] sm:p-8">
                        ...
                        <header className="mb-7">
                            ...
                            <p className="mt-2 text-center text-sm text-[#53627a] dark:text-[#aab7cc]">
                                Start your learning journey with Learn With Flevian.
                            </p>
                        </header>
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            {/* Account information */}
                            <div className="rounded-[6px] border border-[#d8dee9] bg-[#f8fafc] px-3.5 py-3 text-xs leading-5 text-[#53627a] dark:border-[#2a3850] dark:bg-[#0d1626] dark:text-[#aab7cc]">
                                Your account will be created as a{' '}
                                <span className="font-semibold text-[#1554c0] dark:text-[#6ba3ff]">
                                    Student
                                </span>
                                . You can verify your email after registration.
                            </div>
