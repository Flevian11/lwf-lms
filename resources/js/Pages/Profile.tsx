                            ...
                            <Card className="p-5 sm:p-6">
                                ...
                                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        {!profile.email_verified_at && (
                                            <div className="mt-3 flex flex-col gap-3 rounded-xl border border-amber-200 bg-amber-50/70 p-3.5 dark:border-amber-900/40 dark:bg-amber-950/20 sm:flex-row sm:items-center sm:justify-between">
                                                <div className="min-w-0">
                                                    <p className="text-[11px] font-bold text-amber-800 dark:text-amber-200">
                                                        Email verification required
                                                    </p>

                                                    <p className="mt-0.5 text-[10px] leading-4 text-amber-700/80 dark:text-amber-300/70">
                                                ...
                                                <button
                                                    ...
                                                    className="inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-xl bg-[#1554c0] px-3.5 text-[10px] font-bold text-white shadow-sm transition hover:bg-[#1048a8] disabled:cursor-not-allowed disabled:opacity-60"
                                                >
                                                    {verificationForm.processing ? (
                                                        <>
                                        ...
                                        {profile.email_verified_at && (
                                            <div className="mt-3 flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50/70 px-3.5 py-3 dark:border-emerald-900/40 dark:bg-emerald-950/20">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[9px] text-emerald-700/70 dark:text-emerald-300/70">
                            ...
                            <Card className="p-5 sm:p-6">
                                ...
                                <div className="mt-4 rounded-xl border border-[#dbe5f3] bg-[#f7faff] px-3 py-2.5 dark:border-slate-800 dark:bg-slate-900/70">
                                    <p className="text-[10px] leading-4 text-slate-500 dark:text-slate-400">
                                        Linked accounts are managed by your
                                        authentication provider and are shown here
